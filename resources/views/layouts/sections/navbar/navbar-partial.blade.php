  ...
  @if ($configData['hasCustomizer'] == true)
    ...
    <div class="navbar-nav align-items-center">
      ...
      <li class="nav-item me-2 me-xl-0">
        <a class="mweather-widget" href="javascript:void(0);" id="weather-widget">
          <span class="ms-2 d-none d-md-inline-block" id="weather-city">الإسكندرية</span>
          <span class="ms-1 d-none d-sm-inline-block" id="weather-temp">--°C</span>
          <i id="weather-icon" class="tabler-cloud-question icon-base ti icon-md"></i>
        </a>
      </li>
    </div>
    <!-- / Style Switcher-->
